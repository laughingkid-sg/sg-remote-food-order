...
export function ServiceTagPill({ tag, href }: { tag: ServiceTag; href?: string }) {
  ...
  const className =
    "inline-flex shrink-0 items-center whitespace-nowrap rounded-full bg-stone-100 px-2.5 py-0.5 text-xs font-medium text-stone-700 dark:bg-stone-800 dark:text-stone-300";
  return href ? (
